    ...
    create_table :stock_adjustments, id: :uuid do |t|
      t.references :inventory,
                   ...
                   foreign_key: {
                     ...
                     name: :fk_stock_adjustments_inventory_id_on_inventories,
                     on_delete: :cascade
                   },
                   null: false,
                   index: {using: :btree}
      t.references :adjustable,
                   type: :uuid,
                   polymorphic: true,
                   null: false,
                   index: {using: :btree}
      ...
      t.references :unit,
                   ...
                   null: false,
                   index: {using: :btree}
      t.enum :adjustment_type, enum_type: :stock_adjustment_types, index: {using: :btree}
      ...
      t.check_constraint "adjustment_type IN (#{enum_values('stock_adjustment_types')})", name: :check_stock_adjustments_adjustment_type_in_enum_values
