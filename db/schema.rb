...
ActiveRecord::Schema[8.0].define(version: 2025_02_24_150300) do
  ...
  create_enum "tax_types", ["vat", "gst", "tin", "ein", "ssn", "itin", "pan", "tan", "gstin", "vatin", "eori", "nif", "cif", "siret", "siren", "utr", "pcn", "bn", "qst", "abn", "acn", "tfn", "ird", "rfc", "cuit", "cuil", "ruc", "nit", "cnpj", "cpf", "npwp", "trn", "kra_pin", "brn", "pic", "inn", "kpp", "ogrn", "ogrnip", "brn_kr", "uscc", "mst", "tin_ph", "tin_th", "uen"]
  ...
  create_table "tax_details", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.check_constraint "country IS NOT NULL OR (tax_type <> ALL (ARRAY['ein'::tax_types, 'ssn'::tax_types, 'itin'::tax_types, 'pan'::tax_types, 'tan'::tax_types, 'gstin'::tax_types, 'vatin'::tax_types, 'eori'::tax_types, 'nif'::tax_types, 'cif'::tax_types, 'siret'::tax_types, 'siren'::tax_types, 'utr'::tax_types, 'pcn'::tax_types, 'bn'::tax_types, 'qst'::tax_types, 'abn'::tax_types, 'acn'::tax_types, 'tfn'::tax_types, 'ird'::tax_types, 'rfc'::tax_types, 'cuit'::tax_types, 'cuil'::tax_types, 'ruc'::tax_types, 'nit'::tax_types, 'cnpj'::tax_types, 'cpf'::tax_types, 'npwp'::tax_types, 'trn'::tax_types, 'kra_pin'::tax_types, 'brn'::tax_types, 'pic'::tax_types, 'inn'::tax_types, 'kpp'::tax_types, 'ogrn'::tax_types, 'ogrnip'::tax_types, 'brn_kr'::tax_types, 'uscc'::tax_types, 'mst'::tax_types, 'tin_ph'::tax_types, 'tin_th'::tax_types, 'uen'::tax_types]))", name: "check_tax_details_tax_type_requires_country"
  ...
  add_foreign_key "tax_details", "users", name: "fk_tax_details_user_id_on_users", on_delete: :cascade
