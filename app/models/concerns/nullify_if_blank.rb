...
# Mixin module that sets attributes to nil prior to validation if they are blank
# (are false, empty or contain only whitespace), to avoid unnecessarily persisting
# empty strings.
#
# Model usage:
#
