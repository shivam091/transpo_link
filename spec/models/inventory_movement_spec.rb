...
RSpec.describe InventoryMovement, type: :model do
  ...
  describe "attributes, indexes, foreign keys, and check constraints" do
    ...
    it { is_expected.to have_db_index([:inventory_id, :source_id, :source_type, :movement_type]).unique }
    ...
    it { is_expected.to have_check_constraint(:check_inventory_movements_quantity_nonzero).with_expression("quantity <> 0") }
  ...
  describe "associations" do
    ...
    it { is_expected.to belong_to(:source).optional(true) }
  end
end
