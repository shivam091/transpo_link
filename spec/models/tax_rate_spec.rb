...
RSpec.describe TaxRate, type: :model do
  ...
  describe "attributes, indexes, foreign keys, and check constraints" do
    ...
    it { is_expected.to have_db_index([:country, :tax_type, :valid_from, :valid_to]).unique(true) }
    ...
    it { is_expected.to have_check_constraint(:check_tax_rates_valid_from_to_comparison).with_expression("valid_to IS NULL OR valid_to > valid_from") }
  end
