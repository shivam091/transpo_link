...
# spec/errors/unit_conversion_error_spec.rb

require "spec_helper"

RSpec.describe UnitConversionError do
  ...
  it "returns a translated message" do
    ...
    allow(I18n).to receive(:t).with(:unit_conversion_failed, scope: "errors", source_unit: "Kilogramme (kg)", target_unit: "Gramme (g)") { 'Cannot convert from "Kilogramme (kg)" to "Gramme (g)"' }
