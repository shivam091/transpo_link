...
RSpec.describe Inventories::UpdateAverageCostPriceService, type: :service do
  ...
  let(:inventory) do
    create(:inventory).tap do |inventory|
      create(:inventory_batch, quantity: 100, cost_price: 10.0, source:, inventory:)
      create(:inventory_batch, quantity: 200, cost_price: 12.0, source:, inventory:)
      create(:inventory_batch, quantity: 150, cost_price: 11.0, source:, inventory:)
    end
  end
